        ...
        <header class="header--big">
            <div class="header__inner">
                ...
                <form action="{{route('products.search')}}">
                    <input style="background-image: url('{{ asset('images/search.svg')}}')" class="header__search" value="{{Request::old('search')}}" type="text" placeholder="Search products" name="search" id="search">
                </form>
            </div>
        </header>
